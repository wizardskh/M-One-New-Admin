...
public class EpisodeFragment extends Fragment {
    ...
    CheckBox isEp;  //   test ep
    FloatingActionButton add;  //  test ep
    ...
    TextView sr,name,category;   //  from series item
    int position;
    ImageView image;
    Button btnmore;
    String str;
...
//        });
        ...
        add = myView.findViewById(R.id.add);  //   test ep
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {          //    test ep
                Episode episodepopup = new Episode(); //     test ep
                episodepopup.show(getFragmentManager(),"Show Episode"); //        test ep
            }
        });                              //
        isEp = myView.findViewById(R.id.isep);   //   test  ep   for isEp.setOnclickListener
        ...
        sr.setText(str);
        name.setText(seriesModel.seriesName);   //   here   series model start working
    ...
    {
        episodeRef.whereEqualTo("episodeSeries",seriesModel.seriesName)    // "episodeSeries" from episodemodel
...
//
//    public static void addEpisode(int position)    //    test ep   this is for   options popup menu
//    {
//        episodeRef.document(epIds.get(position)).update(epIds.get());   //
//        loadData();                      //
//    }       //
